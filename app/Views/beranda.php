...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-info border-bottom shadow-lg">
  <h5 class="my-0 mr-md-auto font-weight-normal">Aulia Hotel</h5>
  <nav class="my-2 my-md-0 mr-md-3">
	<a class="p-2 text-dark" href="<?=site_url();?>">Order Kamar</a>
  ...
  if(isset($JudulHalaman)){
    ...
    <div class="card mb-4 shadow-sm">
  	...
  	<div class="card-body">
    	...
    	<a href="<?=site_url('/order/'.$row['id_kamar']);?>" class="btn btn-sm btn-block btn-outline-danger">Order</a>
  	</div>
	</div>
